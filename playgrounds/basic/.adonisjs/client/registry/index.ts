...
const routes = {
  ...
  'accounts.upload_profile_picture': {
    ...
    tokens: [{"old":"/users/profile-picture","type":0,"val":"users","end":""},{"old":"/users/profile-picture","type":0,"val":"profile-picture","end":""}],
  ...
  'contacts.page': {
    ...
    tokens: [{"old":"/contacts-page","type":0,"val":"contacts-page","end":""}],
    types: placeholder as Registry['contacts.page']['types'],
  },
  'contacts.list': {
    methods: ["GET","HEAD"],
    pattern: '/contacts',
    tokens: [{"old":"/contacts","type":0,"val":"contacts","end":""}],
    types: placeholder as Registry['contacts.list']['types'],
  },
  'contacts.show': {
    methods: ["GET","HEAD"],
    pattern: '/contacts/:id',
  ...
  'contacts.delete': {
    ...
    pattern: '/contacts/:id',
    tokens: [{"old":"/contacts/:id","type":0,"val":"contacts","end":""},{"old":"/contacts/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['contacts.delete']['types'],
  },
  'products.search': {
    methods: ["GET","HEAD"],
  ...
  'products.categories': {
    ...
    tokens: [{"old":"/products/categories","type":0,"val":"products","end":""},{"old":"/products/categories","type":0,"val":"categories","end":""}],
    types: placeholder as Registry['products.categories']['types'],
  },
  'products.by_category': {
    methods: ["GET","HEAD"],
    pattern: '/products/category/:category',
    tokens: [{"old":"/products/category/:category","type":0,"val":"products","end":""},{"old":"/products/category/:category","type":0,"val":"category","end":""},{"old":"/products/category/:category","type":1,"val":"category","end":""}],
