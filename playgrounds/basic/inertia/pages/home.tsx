    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-900">
      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
          ...
          <Link
            href="/contacts-page"
            className="group relative overflow-hidden rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm p-8 transition-all duration-300 hover:bg-white/10 hover:border-rose-500/50 hover:shadow-xl hover:shadow-rose-500/10"
          >
            <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-rose-500/20 to-transparent rounded-full -translate-y-1/2 translate-x-1/2 group-hover:scale-150 transition-transform duration-500"></div>

            <div className="relative">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-rose-500 to-orange-500 flex items-center justify-center shadow-lg shadow-rose-500/30">
                  <span className="text-2xl">🛡️</span>
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-white">Contacts</h2>
                  <p className="text-sm text-slate-400">safe() & isStatus() error handling</p>
                </div>
              </div>
              ...
              <div className="space-y-3 mt-6">
                <div className="flex items-center gap-3 text-slate-300">
                  ...
                  <span className="text-sm">.safe() non-throwing errors</span>
                </div>
                <div className="flex items-center gap-3 text-slate-300">
                  <div className="w-6 h-6 rounded-full bg-rose-500/20 flex items-center justify-center">
                    <svg
                  ...
                  <span className="text-sm">isStatus() type narrowing</span>
                </div>
                <div className="flex items-center gap-3 text-slate-300">
                  <div className="w-6 h-6 rounded-full bg-rose-500/20 flex items-center justify-center">
                    <svg
                  ...
                  <span className="text-sm">Route.Error&lt;&gt; for try/catch</span>
                </div>
                <div className="flex items-center gap-3 text-slate-300">
                  <div className="w-6 h-6 rounded-full bg-rose-500/20 flex items-center justify-center">
                    <svg
                  ...
                  <span className="text-sm">Typed error responses</span>
                </div>
              </div>

              <div className="mt-6 flex items-center gap-2 text-rose-400 group-hover:gap-3 transition-all">
                <span className="font-medium">Explore</span>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    strokeLinecap="round"
