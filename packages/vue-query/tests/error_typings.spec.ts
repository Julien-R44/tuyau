...
import { renderComposable } from './helpers/index.ts'
...
test.group('Typing | errors', () => {
  test('queryOptions exposes typed error narrowing', ({ expectTypeOf }) => {
    ...
    expectTypeOf(result.error.value).toEqualTypeOf<QueryError | null>()
  ...
  test('mutationOptions exposes typed error narrowing', ({ expectTypeOf }) => {
    ...
    expectTypeOf(result.error.value).toEqualTypeOf<MutationError | null>()
  ...
  test('infiniteQueryOptions exposes typed error narrowing', ({ expectTypeOf }) => {
    ...
    expectTypeOf(result.error.value).toEqualTypeOf<InfiniteQueryError | null>()
